	...
	<div class="main-content" :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0px 0px 0","margin":"0px","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","fontSize":"inherit"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"margin":"20px 0","color":"#fff","flexWrap":"wrap","textAlign":"left","flexDirection":"row","display":"flex","width":"100%","fontSize":"inherit","order":"1","gap":"10px"}'>
				<el-button class="add" type="success" size="medium" @click="addOrUpdateHandler()" :style='{"background":"#67c23a","borderColor":"#67c23a","color":"#fff","fontWeight":"bold"}'>
					<i class="el-icon-plus"></i>
					新增轮播图
				</el-button>
				<el-button class="del" type="danger" size="medium" :disabled="dataListSelections.length <= 0" @click="deleteHandler()" :style='{"fontWeight":"bold"}'>
			...
			<div :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0px 0 0","borderRadius":"12px","background":"rgba(255,255,255,.9)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						...
						<el-button class="del" v-if=" isAuth('config','删除') " type="danger" @click="deleteHandler(scope.row.id)">
							<span class="icon iconfont icon-shanchu1" :style='{"margin":"0 2px","fontSize":"inherit","color":"inherit","height":"40px"}'></span>
							删除
						</el-button>
...
import AddOrUpdate from "./add-or-update";
    ...
    getDataList() {
      ...
      // 如果有搜索关键字，使用搜索关键字，否则查询所有轮播图
      if (this.searchForm.key) {
        params['name'] = '%' + this.searchForm.key + '%'
      }
			this.$http({
				url: "config/page",
				method: "get",
...
<style lang="scss" scoped>
	...
	.main-content .el-pagination ::v-deep .el-pagination__sizes .el-input .el-select__caret {
				cursor: pointer;
				color: #C0C4CC;
				width: 25px;
				font-size: 14px;
