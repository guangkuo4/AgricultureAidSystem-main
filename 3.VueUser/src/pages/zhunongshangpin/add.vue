    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="图片" v-if="type!='cross' || (type=='cross' && !ro.tupian)" prop="tupian">
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="图片" prop="tupian">
                ...
                <img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="baseUrl+'upload/'+item" width="100" height="100">
            </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="农商/企业账号" prop="nonghuzhanghao">
            <el-input v-model="ruleForm.nonghuzhanghao" 
                placeholder="农商/企业账号" clearable :disabled=" false  ||ro.nonghuzhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="农商/企业姓名" prop="nonghuxingming">
            <el-input v-model="ruleForm.nonghuxingming" 
                placeholder="农商/企业姓名" clearable :disabled=" false  ||ro.nonghuxingming"></el-input>
          </el-form-item>
  ...
  export default {
    ...
    // 多级联动参数
      ...
      tupianUploadChange(fileUrls) {
          this.ruleForm.tupian = fileUrls.replace(new RegExp(this.$config.resourceUrl,"g"),"").replace(new RegExp(this.$config.baseUrl+"upload/","g"),"").replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
    }
  };
</script>
